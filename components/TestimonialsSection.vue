...
const fallbackAvatarSrcs = [
  '/images/testimonials/matthiasKohler.jpg',
  '/images/testimonials/lauraKim.jpg',
  '/images/testimonials/michaelChen.jpg',
  '/images/testimonials/isabelleMoreau.jpg',
  '/images/testimonials/eliseGarnier.jpg',
];
