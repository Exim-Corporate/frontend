  ...
  >
    <div class="flex flex-col gap-8 md:flex-row md:items-center md:gap-10">
      <div class="mx-auto flex w-full max-w-md flex-col items-center gap-5 md:mx-0 md:w-2/5 md:items-start md:gap-8">
        ...
        <AnimatedElement direction="bottom" :delay="150">
          <BaseText
            variant="main"
      ...
      <AnimatedElement direction="bottom" :delay="200"           class="group isolate relative ml-auto block h-90 w-full max-w-2xl overflow-hidden rounded-[20px] md:h-112 md:w-3/5 md:max-w-none"
>
        <NuxtLink
          v-if="article"
          :to="heroArticlePath"
