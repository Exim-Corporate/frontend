    ...
    locales: [
      {
        code: 'en',
        iso: 'en-US',
        files: ['en.ts', 'en/team.ts', 'en/testimonials.ts', 'en/referrals.ts', 'sections/case-studies-en.ts'],
        name: 'English',
      },
      {
        code: 'de',
        iso: 'de-DE',
        files: ['de.ts', 'de/team.ts', 'de/testimonials.ts', 'de/referrals.ts', 'sections/case-studies-de.ts'],
        name: 'Deutsch',
      },
      {
        code: 'fr',
        iso: 'fr-FR',
        files: ['fr.ts', 'fr/team.ts', 'fr/testimonials.ts', 'fr/referrals.ts', 'sections/case-studies-fr.ts'],
        name: 'Français',
      },
      {
        code: 'es',
        iso: 'es-ES',
        files: ['es.ts', 'es/team.ts', 'es/testimonials.ts', 'es/referrals.ts', 'sections/case-studies-es.ts'],
        name: 'Español',
      },
    ],
