  ...
  <div class="min-h-screen bg-gray-50 py-8">
    <div class="container mx-auto px-4">
      ...
      <header class="mb-8 text-center">
        <h1 class="text-3xl font-bold text-gray-900 mb-2"> 📧 Email Template Preview </h1>
        <p class="text-gray-600">
          Preview email templates in different languages without sending actual emails
        </p>
        <div
      ...
      <section class="mt-8 bg-blue-50 rounded-lg p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-blue-800">
          <ul class="space-y-1">
            <li>• This preview uses mock data to demonstrate email templates</li>
            <li>• Switch between languages to test internationalization</li>
            <li>• Compare admin and user email templates</li>
          </ul>
          <ul class="space-y-1">
...
/**
 * Fetches email preview from API
 */
async function fetchPreview(): Promise<void> {
  try {
    ...
    const response = await $fetch<EmailPreviewResponse>('/api/preview/email', {
      params: {
...
/** SEO metadata */
useSeoMeta({
  title: 'Email Template Preview - Development Tool',
  description: 'Preview email templates in different languages for testing purposes',
