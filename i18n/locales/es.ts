...
export default {
  ...
  booking: {
    ...
    failedToLoad: 'No pudimos cargar el widget de reservas en este momento. Inténtalo de nuevo o contáctanos por correo.',
    preferEmail: '¿Prefieres correo? Escríbenos directamente a',
  },
  servicesCards: {
    aiConsulting: {
  ...
  blog: {
    ...
    hero_label: 'Blog',
    hero_subtitle: 'Insights, guías y aprendizajes reales de nuestro equipo de ingeniería',
  ...
  contact: {
    ...
    placeholders: {
      ...
      projectInformation: 'Añada detalles sobre su proyecto',
    ...
    validation: {
      ...
      project_information_required: 'La información del proyecto es obligatoria',
    ...
    navigation: {
      industry: {
        ...
        items: {
          ...
          logistics: 'Logística',
          retail: 'Retail',
          financeAndFinTech: 'Finanzas y FinTech',
          educationAndEdTech: 'Educación y EdTech',
      ...
      services: {
        ...
        items: {
          ...
          customSoftwareDevelopment: 'Desarrollo de Software a Medida',
          webApplicationDevelopment: 'Desarrollo de Aplicaciones Web',
  ...
  contactMail: {
    ...
    user: {
      ...
      regards: 'Saludos cordiales,\nEl equipo de AS Exim LTD',
      whatsNext: '¿Qué sigue?',
      step1: 'Nuestro equipo revisará sus requisitos dentro de 24-48 horas y le devolverá la estimación',
      step2: 'Programaremos una llamada con usted para discutir la estimación en profundidad y revelar cualquier cuello de botella',
      step3: 'Una vez que se firma el contrato, inmediatamente comenzamos a trabajar en su producto de ensueño',
      responseTime: '⚡ Tiempo de respuesta esperado',
      responseTimeDetails: 'Nuestro equipo está comprometido a encontrar la mejor solución tecnológica disponible para sus necesidades específicas',
      visitWebsite: 'Visite nuestro sitio web',
      followUs: 'Síguenos en LinkedIn',
      personalNote:
        'Esperamos colaborar con usted en su próximo proyecto.',
      teamSignature: 'El equipo de AS Exim LTD',
      footerText: 'Gracias por elegir AS Exim LTD.',
    },
  },
  hire: {
  ...
  error: {
    ...
    '500': {
      ...
      description: 'Algo salió mal de nuestra parte. Por favor, inténtelo de nuevo más tarde.',
    },
    default: {
