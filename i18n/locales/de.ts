...
export default {
  ...
  contact: {
    ...
    placeholders: {
      ...
      projectInformation: 'Fügen Sie Details zu Ihrem Projekt hinzu',
    ...
    validation: {
      ...
      project_information_required: 'Projektinformationen sind erforderlich',
    ...
    navigation: {
      industry: {
        ...
        items: {
          ...
          logistics: 'Logistik',
          retail: 'Einzelhandel',
          financeAndFinTech: 'Finanzen & FinTech',
          educationAndEdTech: 'Bildung & EdTech',
      ...
      services: {
        ...
        items: {
          ...
          customSoftwareDevelopment: 'Individuelle Softwareentwicklung',
          webApplicationDevelopment: 'Webanwendungsentwicklung',
  ...
  cta: {
    title: 'Bauen Sie Ihr Dream Team schneller auf',
    description:
      'Wir sind überzeugt, dass großartige Technologie von Zusammenarbeit, Präzision und kultureller Passung lebt. Deshalb liefern wir innerhalb von 48 Stunden präzise Projektabschätzungen und bieten flexible Engagement-Modelle — egal ob Sie KI-Initiativen, vollständige Produktentwicklungszyklen oder langfristige technische Unterstützung benötigen.',
  ...
  contactMail: {
    ...
    user: {
      ...
      step1: 'Unser Team wird Ihre Anforderungen innerhalb von 24-48 Stunden prüfen und Ihnen eine Schätzung unterbreiten',
      step2: 'Wir werden einen Anruf mit Ihnen vereinbaren, um die Schätzung ausführlich zu besprechen und Engpässe aufzudecken',
      step3: 'Sobald der Vertrag unterzeichnet ist, beginnen wir sofort mit der Arbeit an Ihrem Traumprojekt',
      responseTime: '⚡ Erwartete Antwortzeit',
      responseTimeDetails: 'Unser Team verpflichtet sich, die beste Technologielösung für Ihre spezifischen Anforderungen zu finden',
      visitWebsite: 'Unsere Website besuchen',
      followUs: 'Folgen Sie uns auf LinkedIn',
      personalNote:
        'Wir freuen uns darauf, mit Ihnen an Ihrem nächsten Projekt zu arbeiten.',
      teamSignature: 'Das AS Exim LTD Team',
      footerText: 'Danke, dass Sie AS Exim LTD gewählt haben.',
    },
  },
  hire: {
